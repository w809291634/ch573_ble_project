 ...
 * @brief 历史命令记录数量
 */
#ifdef BOARD_CFG_SHELL_HISTORY_MAX_NUMBER
#define     SHELL_HISTORY_MAX_NUMBER    BOARD_CFG_SHELL_HISTORY_MAX_NUMBER       // shell 缓存区大小和此处成倍数关系
#else
#define     SHELL_HISTORY_MAX_NUMBER    1       // shell 缓存区大小和此处成倍数关系
#endif
